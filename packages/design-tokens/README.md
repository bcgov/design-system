...
This package is used to export, transform and publish design tokens from Figma as part of the B.C. Design System. Tokens are available as CSS, SCSS and JavaScript variables. Install this library to start using these tokens in your app.
