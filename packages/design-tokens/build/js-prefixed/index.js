...
export const bcdsTypographyRegularDisplay = "400 3rem/NaNAUTO 'BC Sans'"; // Extra-large body text size. Do not use for headings
...
export const bcdsTypographyBoldDisplay = "700 3rem/NaNAUTO 'BC Sans'"; // Extra-large font size (bolded). Do not use for headings
...
export const bcdsTypographyItalicDisplay = "italic 400 3rem/NaNAUTO 'BC Sans'"; // Extra-large font size (italic). Do not use for headings
