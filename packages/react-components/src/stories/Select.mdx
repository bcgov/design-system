...
# Select
<Subtitle>The select component enables the user to select one option from a dropdown list.</Subtitle>

<Source code={`import { Select } from "@bcgov/design-system-react-components"; `} language="typescript" />

Learn more about how to use the select component:
