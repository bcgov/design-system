...
The Form component is useful for composing simple forms or inputs within your UI. For more complex use cases, the B.C. Public Service maintains two powerful form-building products:
