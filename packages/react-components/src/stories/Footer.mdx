...
# Footer
<Subtitle>The Footer component is designed to sit at the bottom of your page.</Subtitle>

<Source code={`import { Footer } from "@bcgov/design-system-react-components"; `} language="typescript" />
