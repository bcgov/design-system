...
A ProgressBar renders a horizontal bar that fills from left to right. A ProgressCircle renders a circular loader that fills clockwise. The same props are available for both formats.

Learn more about working with the ProgressBar and ProgressCircle components:

- [Usage and best practice guidance](https://www2.gov.bc.ca/gov/content?id=7CB2572EFAFD45059FA09E113F355464)
