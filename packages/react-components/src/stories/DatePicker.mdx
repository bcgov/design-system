...
The date format is set automatically based on the user's browser locale. You can adjust formatting using the `granularity`, `hourCycle`, `hideTimeZone` and `shouldForceLeadingZeros` props:
