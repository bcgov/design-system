...
A tag group is a focusable list of **tags** (labels, categories, keywords, filters, or other items) with support for keyboard navigation, selection, and removal. It is built using the [React Aria TagGroup](https://react-spectrum.adobe.com/react-aria/TagGroup.html).
