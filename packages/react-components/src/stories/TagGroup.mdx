...
<Subtitle>A tag group is a focusable list of tags (labels, categories, keywords, filters, or other items) with support for keyboard navigation, selection, and removal.</Subtitle>

<Source code={`import { TagGroup, TagList } from "@bcgov/design-system-react-components"; `} language="typescript" />
