...
<InlineAlert
  ...
  description="It is based on the RA Tag, TagList and TagGroup components. Consult the React Aria docs to understand its full API."
  buttons={[
    <Link
      isButton
      size="small"
      buttonVariant="secondary"
      href="https://react-aria.adobe.com/TagGroup"
      target="_blank"
...
The `Tag` component can be passed a `tagStyle` prop with one of the following values:

- `rectangular`
- `circular`

If no value is passed, the tag tagStyle defaults to `rectangular`.
