...
<Canvas of={LinkStories.LinkTemplate} />
...
Use the `isButton` prop to create a link that looks and behaves like the [Button](/docs/inputs-and-controls-button--docs) component.
