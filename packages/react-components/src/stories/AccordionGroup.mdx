...
<InlineAlert
  ...
  description="It is based on the RA Disclosure and DisclosureGroup components. Consult the React Aria docs to understand its full API."
  buttons={[
    <Link
      isButton
      size="small"
    ...
    <Link
      ...
      target="_blank"
      iconRight={<SvgUpRightFromSquareIcon size="small" />}
      key="disclosuregroup-docs"
    >
      DisclosureGroup docs
    </Link>,
  ]}
/>
