import { Meta, Source, Subtitle } from "@storybook/addon-docs/blocks";
...
# B.C. Design System React Components {packageJson?.version ? `v${packageJson.version}` : null}

<Subtitle>
  UI workshop for React components included in the [B.C. Design
  System](https://gov.bc.ca/designsystem)
</Subtitle>
